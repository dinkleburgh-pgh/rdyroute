        ...
        <aside className="flex flex-col gap-3">
          <div className="card flex flex-col gap-2">
            ...
            <textarea
              ...
              rows={5}
              placeholder="Notes about today's runΓÇª"
        ...
        <div className="space-y-4">
          {isAdmin && (
            <div className="flex gap-2">
              ...
              >
                Γû╢ {wizardDone ? "Run Day Wizard" : "Run Day Wizard ΓÇö needs to run!"}
              </button>
            </div>
          )}
...
function RunDayWizard({
  ...
  const STEP_TITLES = [
    "",
    "Step 1 of 5 ΓÇö Run Mode",
    "Step 2 of 5 ΓÇö Dust Garments",
    "Step 3 of 5 ΓÇö Route Swaps",
    "Step 4 of 5 ΓÇö Trucks Not Here",
    "Step 5 of 5 ΓÇö Daily Notes",
  ];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-700 px-5 py-4">
          ...
          <button className="text-slate-500 hover:text-slate-300" onClick={onClose}>Γ£ò</button>
        </div>

        <div className="p-5">
          {/* ΓöÇΓöÇ Step 1: Run Mode ΓöÇΓöÇ */}
          {step === 1 && (
            <div className="space-y-4">
                ...
                {holidayMode && (
                  <div className="rounded-lg border border-amber-700/40 bg-amber-950/20 p-3 space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      >
                        <div className="text-base">{holidayLoad ? "Γ£ô" : "+"} Load</div>
                      ...
                      >
                        <div className="text-base">{holidayUnload ? "Γ£ô" : "+"} Unload</div>
          ...
          {/* ΓöÇΓöÇ Step 2: Dust Garments ΓöÇΓöÇ */}
          {step === 2 && (
            <div className="space-y-4">
          ...
          {/* ΓöÇΓöÇ Step 3: Route Swaps ΓöÇΓöÇ */}
          {step === 3 && (
                  ...
                  {swaps.map((s) => (
                    ...
                    >
                      <span className="text-sm font-bold text-slate-200">
                        ...
                        <span className="mx-1 text-slate-500">ΓåÆ</span>
              ...
              <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-3 space-y-2">
                ...
                <div className="flex gap-2">
                  <div className="flex-1">
                    ...
                    >
                      <option value="">ΓÇö route ΓÇö</option>
                      {board
                  ...
                  <div className="flex-1">
                    ...
                    >
                      <option value="">ΓÇö truck ΓÇö</option>
                      {board
                ...
                <button
                  ...
                  onClick={addSwap}
                >
                  {createSwap.isPending ? "SavingΓÇª" : "Add Swap"}
                </button>
              </div>
          ...
          {/* ΓöÇΓöÇ Step 4: Trucks Not Here ΓöÇΓöÇ */}
          {step === 4 && (
            <div className="space-y-4">
          ...
          {/* ΓöÇΓöÇ Step 5: Daily Notes ΓöÇΓöÇ */}
          {step === 5 && (
            <div className="space-y-4">
  ...
  return (
    <div className="rounded-md border border-slate-800 bg-slate-900">
      ...
      >
        ...
        <span className="text-xs text-slate-400">{open ? "Γû╛" : "Γû╕"}</span>
      </button>
                  ...
                  {changingId === s.id ? (
                    <div className="space-y-2 p-2">
                      ...
                      <select
                        ...
                        autoFocus
                      >
                        <option value="">ΓÇö pick spare ΓÇö</option>
                        {[
                          ...eligibleSpares,
                          ...
                          .map((t) => (
                            <option key={t.truck_number} value={t.truck_number}>
                              ...
                              {t.truck_number === s.spare_truck_number ? " ΓåÉ current" : ""}
                            </option>
                          ))}
                      </select>
