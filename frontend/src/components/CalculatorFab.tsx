...
export default function CalculatorFab({ open, onClose }: { open: boolean; onClose: () => void }) {
          ...
          >
            ...
            <div className="mx-3 mb-1 flex shrink-0 flex-col overflow-hidden rounded-xl bg-slate-950 md:mx-0">
              <div className="px-3 pb-1 pt-2">
                <div className="text-right text-3xl font-bold tabular-nums text-slate-100 select-none">{display}</div>
              ...
              <div className="max-h-[4.5rem] overflow-y-auto border-t border-slate-800/60 px-3 py-1">
                ...
                {tape.length > 0 && <button onClick={clearTape} className="text-[9px] text-slate-600 hover:text-slate-400">Clear</button>}
              </div>
            </div>
