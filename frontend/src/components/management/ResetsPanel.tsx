  ...
  return (
    <div className="space-y-4">
      <div className="flex items-end justify-between gap-4">
        <p className="text-xs text-ink-muted">Destructive operations for the selected run date.</p>
        <div>
      ...
      <div className="card space-y-4">
        <div className="flex items-center justify-between gap-4">
          <div>
            <p className="text-sm font-medium text-ink-soft">Remove abnormal load times</p>
            <p className="text-xs text-ink-muted">Deletes statistical outliers from load-time history used for pace averaging.</p>
        ...
        <div className="border-t border-hairline pt-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-medium text-ink-soft">Reset day</p>
